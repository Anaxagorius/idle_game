...
Game.config.STOCK_CYCLE_EVENT_TRIGGER_CHANCE = 0.2;
Game.config.STOCK_CYCLE_EVENT_KIND_WEIGHTS = { good: 25, bad: 25, mixed: 50 };
Game.config.stockCycleEvents = [
  { id: "rate_cut_relief", kind: "good", icon: "🏦", color: "#43aa8b", name: "Central Bank Rate Cut", desc: "Cheaper borrowing lifts risk appetite across the market.", marketDrift: 0.01, volatilityMult: 0.92, sectorEffects: { Finance: 0.006, Realty: 0.008, REIT: 0.008, Construction: 0.006, Auto: 0.004 } },
  { id: "trade_deal", kind: "good", icon: "🤝", color: "#43aa8b", name: "Major Trade Deal", desc: "Tariff relief and new export access boost industrial confidence.", marketDrift: 0.009, volatilityMult: 0.9, sectorEffects: { Logistics: 0.01, Shipping: 0.01, Industry: 0.008, Materials: 0.007, Auto: 0.006 } },
  { id: "breakthrough_drug", kind: "good", icon: "💊", color: "#43aa8b", name: "Breakthrough Drug Approval", desc: "Healthcare and biotech rally after a landmark treatment wins approval.", marketDrift: 0.004, volatilityMult: 0.96, sectorEffects: { Healthcare: 0.014, Biotech: 0.018, Consumer: 0.003 } },
  { id: "chip_subsidy", kind: "good", icon: "🧠", color: "#43aa8b", name: "Semiconductor Subsidy Package", desc: "Public investment accelerates domestic chip and cloud expansion.", marketDrift: 0.006, volatilityMult: 0.94, sectorEffects: { Semiconductors: 0.016, Tech: 0.01, Compute: 0.01, Cloud: 0.01, Robotics: 0.007 } },
  { id: "oil_supply_relief", kind: "good", icon: "🛢️", color: "#43aa8b", name: "Strategic Oil Release", desc: "Lower energy costs ease inflation pressure for transport and consumers.", marketDrift: 0.007, volatilityMult: 0.93, sectorEffects: { Logistics: 0.009, Shipping: 0.008, Travel: 0.008, Retail: 0.006, Consumer: 0.006, Energy: -0.006 } },
  { id: "rate_hike_shock", kind: "bad", icon: "📉", color: "#e63946", name: "Rate Hike Shock", desc: "Higher yields hit valuations and tighten financial conditions.", marketDrift: -0.011, volatilityMult: 1.15, sectorEffects: { Tech: -0.009, Cloud: -0.009, Compute: -0.008, Realty: -0.01, REIT: -0.01, Finance: -0.004 } },
  { id: "banking_crisis", kind: "bad", icon: "🏛️", color: "#e63946", name: "Regional Banking Crisis", desc: "Credit fears spread as deposit outflows pressure lenders.", marketDrift: -0.012, volatilityMult: 1.18, sectorEffects: { Finance: -0.018, Insurance: -0.01, Realty: -0.007, REIT: -0.007 } },
  { id: "oil_embargo", kind: "bad", icon: "⛽", color: "#e63946", name: "Oil Embargo", desc: "Fuel costs surge and squeeze transport-heavy businesses.", marketDrift: -0.009, volatilityMult: 1.16, sectorEffects: { Energy: 0.012, Logistics: -0.012, Shipping: -0.011, Travel: -0.012, Consumer: -0.006, Retail: -0.006 } },
  { id: "port_strike", kind: "bad", icon: "🚢", color: "#e63946", name: "Port Strike", desc: "Cargo bottlenecks disrupt inventories and industrial delivery schedules.", marketDrift: -0.008, volatilityMult: 1.12, sectorEffects: { Shipping: -0.015, Logistics: -0.014, Retail: -0.007, Industry: -0.007, Food: -0.006 } },
  { id: "debt_panic", kind: "bad", icon: "💸", color: "#e63946", name: "Sovereign Debt Panic", desc: "Bond stress spills into equities as funding risk rises.", marketDrift: -0.013, volatilityMult: 1.2, sectorEffects: { Finance: -0.012, Insurance: -0.01, Utilities: -0.007, Infrastructure: -0.007, Construction: -0.008 } },
  { id: "inflation_surprise", kind: "mixed", icon: "🧾", color: "#f6c453", name: "Inflation Surprise", desc: "Sticky inflation lifts commodity plays while pressuring rate-sensitive sectors.", marketDrift: -0.002, volatilityMult: 1.08, sectorEffects: { Energy: 0.009, Materials: 0.008, Agriculture: 0.007, Finance: 0.004, Realty: -0.01, REIT: -0.01, Consumer: -0.006 } },
  { id: "defense_spending_bill", kind: "mixed", icon: "🛡️", color: "#f6c453", name: "Defense Spending Bill", desc: "New military budgets favor defense and aerospace while fiscal worries drag others.", marketDrift: 0.001, volatilityMult: 1.04, sectorEffects: { Defense: 0.016, Space: 0.01, Industry: 0.005, Finance: -0.003, Consumer: -0.003 } },
  { id: "canal_blockage", kind: "mixed", icon: "🚧", color: "#f6c453", name: "Shipping Canal Blockage", desc: "Freight delays hit global trade, but domestic producers gain pricing power.", marketDrift: -0.003, volatilityMult: 1.1, sectorEffects: { Shipping: -0.016, Logistics: -0.014, Retail: -0.006, Food: 0.006, Agriculture: 0.005, Utilities: 0.003 } },
  { id: "ai_spending_boom", kind: "mixed", icon: "🤖", color: "#f6c453", name: "AI Spending Boom", desc: "Compute and software surge while labor-heavy incumbents lag.", marketDrift: 0.004, volatilityMult: 1.06, sectorEffects: { Tech: 0.012, Cloud: 0.013, Compute: 0.014, Semiconductors: 0.013, Telecom: 0.006, Retail: -0.004, Insurance: -0.003 } },
  { id: "antitrust_crackdown", kind: "mixed", icon: "⚖️", color: "#f6c453", name: "Antitrust Crackdown", desc: "Mega-cap tech stumbles while smaller competitors and telecom rebound.", marketDrift: -0.003, volatilityMult: 1.09, sectorEffects: { Tech: -0.013, Cloud: -0.011, Compute: -0.009, Telecom: 0.008, Media: 0.005, Retail: 0.003 } },
  { id: "foundry_fire", kind: "mixed", icon: "🔥", color: "#f6c453", name: "Chip Foundry Fire", desc: "Hardware shortages hurt manufacturers but alternative suppliers jump.", marketDrift: -0.002, volatilityMult: 1.11, sectorEffects: { Semiconductors: 0.011, Tech: -0.007, Robotics: -0.008, Auto: -0.009, Compute: -0.006 } },
  { id: "hospitality_rebound", kind: "mixed", icon: "✈️", color: "#f6c453", name: "Travel Rebound", desc: "Consumers rotate into leisure while defensive yield stocks cool off.", marketDrift: 0.003, volatilityMult: 1.03, sectorEffects: { Travel: 0.016, Media: 0.007, Retail: 0.005, Utilities: -0.005, Power: -0.005, REIT: -0.004 } },
  { id: "farm_drought", kind: "mixed", icon: "🌾", color: "#f6c453", name: "Agricultural Drought", desc: "Crop shortages raise food prices and stress consumer staples.", marketDrift: -0.002, volatilityMult: 1.08, sectorEffects: { Agriculture: -0.012, Food: -0.01, Consumer: -0.006, Utilities: 0.004, Materials: 0.003 } },
  { id: "telecom_rollout", kind: "mixed", icon: "📡", color: "#f6c453", name: "Telecom Infrastructure Rollout", desc: "Network investment favors telecom and infrastructure while margins compress elsewhere.", marketDrift: 0.002, volatilityMult: 1.05, sectorEffects: { Telecom: 0.014, Infrastructure: 0.011, Construction: 0.008, Cloud: 0.005, Finance: -0.003, Utilities: -0.003 } },
  { id: "exchange_cyberattack", kind: "mixed", icon: "🔐", color: "#f6c453", name: "Exchange Cyberattack", desc: "Finance and cloud spending react sharply as defensive software demand rises.", marketDrift: -0.004, volatilityMult: 1.14, sectorEffects: { Finance: -0.012, Insurance: -0.008, Cloud: 0.008, Compute: 0.007, Tech: 0.004 } },
];
Game.config.stockCycleEventMap = {};
Game.config.stockCycleEventsByKind = { good: [], bad: [], mixed: [] };
Game.config.stockCycleEvents.forEach(function (event) {
  Game.config.stockCycleEventMap[event.id] = event;
  if (Game.config.stockCycleEventsByKind[event.kind]) Game.config.stockCycleEventsByKind[event.kind].push(event);
});
